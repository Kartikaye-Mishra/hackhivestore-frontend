...
const SingleProduct = () => {
    ...
    // const  data  = useFetch(`https://hackhivestore.onrender.com/api/products?populate=*&[filters][id]=${id}`);
...
console.log("Data on single Product is, ",product);
        ...
        <div className="single-product-main-content">
            <div className="layout">
                <div className="single-product-page">
                    <div className="left">
                        <img
                            src={ product.image.data.attributes.url} alt=""
                        />
                        {/* <img
